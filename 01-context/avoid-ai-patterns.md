...
* **Nouns:** tapestry, journey, echo, whisper, shadow, ghost(s), landscape (as catch-all: "competitive landscape," "digital landscape," etc.), realm, paradigm
* **Atmosphere words:** quiet, hum/humming, woven/weave -- note: "quiet" is an especially common AI crutch (quiet confidence, quiet rebellion, quietly growing)
...
* **"Honestly?" opener** followed by something completely unremarkable ("Honestly? Most people don't follow up.")
...
* **Faux balance** -- acknowledging "both sides" or admitting a concern, then proceeding exactly as planned. Nothing is actually weighed or traded off
...
* **Metaphors that almost land** -- comparisons that sound clever but don't actually map to the subject. Creates cognitive friction
...
* **Overuse of em dashes** -- especially multiple per paragraph
...
* Overwrought, false sincerity ("woven into your daily rhythm")
* Wide-eyed, overeager enthusiasm
* Gesturing at depth without substance (piling metaphors that collapse into nonsense)
* Describing everything as ghostly, spectral, echoing, or quiet when it isn't
* Corporate-inspirational filler that says everything and nothing ("revolutionize the way," "breakthrough advancement")
* Performative empathy or validation in contexts that don't call for it
