...
While optimized for product/platform teams, these principles apply broadly to engineering, product, design, operations, and infrastructure teams.
...
- **jira**: Search your issue tracker. Use this to:
  - Find epics or initiatives related to the OKRs being drafted or reviewed.
  - Verify that Key Results align with planned or in-flight work.
  - Check whether proposed metrics or targets are already tracked in existing tickets.
  - Surface dependencies on other teams' work queues.
...
Read and apply relevant skills from `.opencode/skills/` based on the OKR context:

| Skill | When to Use |
|-------|-------------|
| `pm-thinking` | **Always** — ensures OKRs are outcome-focused, problem-first, and measurable |
| `company-context` | When drafting/reviewing OKRs for your teams — grounds OKRs in your product context |
| `team-context` | When drafting/reviewing OKRs for a specific team — applies team-specific principles and constraints |

**Apply skills proactively** — load relevant context before drafting or reviewing any OKRs.
